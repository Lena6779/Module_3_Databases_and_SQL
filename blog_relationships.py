...
with Session(engine) as session:
    ...
    post1 = Post(
        ...
        tags=[python_tag, tutorial_tag, beginner_tag]  # Many-to-many
    )
...
# Step 3: Navigate one-to-man relationships
...
# Step 4: Navigate many-to-many relationships
...
# Step 5: Adding to existing relationships
